...
async function seed(get: Get, prisma: PrismaService): Promise<void> {
  ...
  for (const [cur, [start, end]] of Object.entries(RATES_TO_USD)) {
    for (const [i, date] of points.entries()) {
      ...
      await settings.saveExchangeRate(nadia, {
        rateDate: date,
        fromCurrency: cur,
        toCurrency: 'USD',
        rate: rate.toFixed(6),
  ...
  const cat = async (code: string) =>
    (await prisma.productCategory.findUniqueOrThrow({ where: { code } })).id;
  const packaging = async (code: string) =>
    (await prisma.packagingType.findUniqueOrThrow({ where: { code } })).id;
  ...
  const supplierData = [
    {
      ...
      contact: {
        ...
        whatsapp: '+90 532 000 1122',
        email: 'mehmet@anatolia-elyaf.example',
      },
      bank: {
        bankName: 'Türkiye İş Bankası',
        accountName: 'Anatolia Elyaf Sanayi A.Ş.',
    ...
    },
    {
      ...
      contact: {
        ...
        whatsapp: '+90 533 111 2233',
        email: 'ayse@marmarapolyester.example',
      },
      bank: {
        bankName: 'Garanti BBVA',
        accountName: 'Marmara Polyester Tekstil',
    ...
    },
    {
      ...
      contact: {
        name: 'Burak Aydın',
        position: 'Export Executive',
        phone: '+90 535 222 3344',
        email: 'burak@egeiplik.example',
      },
      bank: null,
    },
    {
      ...
      contact: {
        ...
        email: 'lily@huaxinfiber.example',
      },
      bank: {
        bankName: 'Bank of China, Jiangsu Branch',
        accountName: 'Jiangsu Huaxin Chemical Fiber Co Ltd',
        accountNumber: '4712 5820 3316',
        swift: 'BKCHCNBJ940',
        currency: 'USD',
      },
    },
    {
      ...
      contact: {
        ...
        phone: '+86 139 5555 6789',
        whatsapp: '+86 139 5555 6789',
        email: 'kevin@hengyuanmicro.example',
      },
      bank: {
        bankName: 'Industrial and Commercial Bank of China',
        accountName: 'Zhejiang Hengyuan Microfiber Co Ltd',
        accountNumber: '1211 0260 0920 0123 456',
        swift: 'ICBKCNBJZJP',
        currency: 'USD',
      },
    },
    {
      ...
      contact: {
        name: 'Grace Lin',
        position: 'Export Manager',
        phone: '+86 137 7777 8888',
        email: 'grace@jinlunfiber.example',
      },
      bank: null,
    },
  ];
  ...
  for (const s of supplierData) {
    const created = await suppliers.create(wei, {
      ...
      addresses: [
        { type: 'BILLING', line1: s.address, city: s.city, countryCode: s.countryCode, isDefault: true },
      ],
    });
    supplierIds[s.key] = created.id;
    if (s.bank) {
      const withBank = await suppliers.addBankAccount(wei, created.id, {
        accountNumber: null,
        iban: null,
        bankAddress: null,
        notes: null,
      ...
      if (s.key !== 'hengyuan')
        await suppliers.approveBankAccount(nadia, created.id, withBank.bankAccounts![0]!.id);
    }
  }
  for (const f of [
    {
      companyName: 'Bosphorus Global Logistics A.Ş.',
      countryCode: 'TR',
      city: 'Istanbul',
      type: 'FORWARDER' as const,
      email: 'ops@bosphoruslogistics.example',
    },
    {
      companyName: 'Oceanlink Shipping Agency (Shanghai) Co.',
      countryCode: 'CN',
      city: 'Shanghai',
      type: 'FORWARDER' as const,
      email: 'booking@oceanlink.example',
    },
    {
      ...
      email: 'textiles@sgs-demo.example',
    },
  ]) {
  ...
  const customerData = [
    {
      key: 'delta',
      owner: selin,
      name: 'Delta Home Textiles S.A.E.',
      country: 'EG',
      ...
      incoterm: 'CFR',
      port: 'EGALY',
      contact: ['Ahmed Soliman', 'Purchasing Manager', '+20 100 123 4567'],
    },
    {
      key: 'nile',
      owner: selin,
      name: 'Nile Bedding Industries',
      country: 'EG',
      city: 'Alexandria',
      currency: 'USD',
      term: 'CAD',
      ...
      incoterm: 'CFR',
      port: 'EGALY',
      contact: ['Mona Hassan', 'Supply Chain Lead', '+20 122 987 6543'],
    },
    {
      key: 'alnoor',
      owner: karim,
      name: 'Al Noor Mattress Factory',
      country: 'SA',
      city: 'Riyadh',
      currency: 'USD',
      term: 'LC-SIGHT',
      ...
      incoterm: 'CFR',
      port: 'SADMM',
      contact: ['Faisal Al-Otaibi', 'Procurement Head', '+966 55 123 4567'],
    },
    {
      key: 'gulf',
      owner: karim,
      name: 'Gulf Comfort Trading LLC',
      country: 'AE',
      city: 'Dubai',
      currency: 'USD',
      term: 'NET60',
      ...
      incoterm: 'CFR',
      port: 'AEJEA',
      contact: ['Rashid Khan', 'General Manager', '+971 50 765 4321'],
    },
    {
      key: 'amman',
      owner: karim,
      name: 'Amman Quilts & Pillows Co.',
      country: 'JO',
      city: 'Amman',
      currency: 'USD',
      term: 'NET90',
      ...
      incoterm: 'CFR',
      port: 'JOAQJ',
      contact: ['Lina Haddad', 'Owner', '+962 79 555 1234'],
    },
    {
      key: 'atlas',
      owner: selin,
      name: 'Atlas Nonwovens SARL',
      country: 'MA',
      city: 'Casablanca',
      currency: 'EUR',
      term: 'ADV20-BL60',
      ...
      incoterm: 'CIF',
      port: 'MACAS',
      contact: ['Youssef El Amrani', 'Directeur Achats', '+212 661 234 567'],
    },
    {
      key: 'polska',
      owner: selin,
      name: 'Polska Fibre Solutions Sp. z o.o.',
      country: 'PL',
      city: 'Łódź',
      currency: 'EUR',
      term: 'NET60',
      ...
      incoterm: 'CIF',
      port: 'PLGDN',
      contact: ['Piotr Nowak', 'Purchasing', '+48 601 234 567'],
    },
    {
      key: 'tessuti',
      owner: selin,
      name: 'Tessuti Imbottiti S.r.l.',
      country: 'IT',
      city: 'Prato',
      currency: 'EUR',
      term: 'NET90',
      ...
      incoterm: 'CIF',
      port: 'ITGOA',
      contact: ['Giulia Bianchi', 'Buyer', '+39 333 123 4567'],
    },
    {
      key: 'lagos',
      owner: karim,
      name: 'Lagos Home Comfort Ltd',
      country: 'NG',
      city: 'Lagos',
      currency: 'USD',
      term: 'CIA',
      ...
      incoterm: 'CFR',
      port: 'NGAPP',
      contact: ['Chinedu Okafor', 'MD', '+234 803 123 4567'],
    },
    {
      key: 'mombasa',
      owner: karim,
      name: 'Mombasa Fibre Works',
      country: 'KE',
      city: 'Mombasa',
      currency: 'USD',
      term: 'ADV30-BL70',
      ...
      incoterm: 'CFR',
      port: 'KEMBA',
      contact: ['Grace Wanjiru', 'Operations', '+254 722 123 456'],
    },
  ];
  ...
  for (const c of customerData) {
    ...
    const created = await customers.create(admin, {
      ...
      contacts: [
        {
          ...
          phone,
          whatsapp: phone,
          email: `${name.split(' ')[0]!.toLowerCase()}@${c.key}.example`,
          isPrimary: true,
          notes: null,
        },
      ],
      addresses: [
        ...
        {
          type: 'SHIPPING',
          line1: `${c.name}, factory warehouse`,
          city: c.city,
          countryCode: c.country,
          isDefault: true,
        },
  ...
  const soAlnoor = await so(
    'alnoor',
    95,
    -30,
    [line(hcs.id, spec.hcs15, '96', '1040'), line(solid.id, spec.solid14, '48', '955')],
    { poRef: 'ANM/PO/2026/118' },
  );
  await confirm(karim, soAlnoor.id);
  const soGulf = await so('gulf', 80, -10, [line(micro.id, spec.micro13, '19.5', '1495')], {
    poRef: 'GCT-4471',
  });
  ...
  const soAtlas = await so('atlas', 45, 10, [
    line(lmf.id, spec.lmf4, '22', '1420'),
    line(solid.id, spec.solid14, '22', '905'),
  ]);
  await confirm(selin, soAtlas.id);
  const soTessuti = await so(
    'tessuti',
    38,
    20,
    [line(micro.id, spec.micro13, '10', '1560', { discountPct: '2' })],
    { poRef: 'TI-26-0147' },
  );
  ...
  const soLagos = await so('lagos', 14, 40, [
    line(yarn.id, spec.dty150, '18000', '1.48', { uom: 'KG', packagingTypeId: carton }),
  ]);
  ...
  const soDraft = await so(
    'gulf',
    2,
    50,
    [line(hcs.id, spec.hcs15, '24', '1055'), line(micro.id, spec.micro13, '6', '1510')],
    { notes: 'Awaiting final quantity from customer' },
  );
  const soPending = await so('alnoor', 3, 55, [line(hcs.id, spec.hcs7, '72', '1135')], {
    poRef: 'ANM/PO/2026/141',
  });
  ...
  await orders.hold(
    management,
    soHold.id,
    soHoldConfirmed.version,
    'Waiting for customer to clear documents on previous shipment',
  );
  ...
  await orders.cancel(
    selin,
    soCancel.id,
    soCancelConfirmed.version,
    'Customer postponed the season; will reorder in Q1',
  );
  ...
  const advance = async (
    id: string,
    to: ('SENT' | 'CONFIRMED' | 'IN_PRODUCTION' | 'READY')[],
    extra: { supplierRef?: string; confirmedReadyDate?: string } = {},
  ) => {
  ...
  await advance(poAlnoor.id, ['SENT', 'CONFIRMED', 'IN_PRODUCTION', 'READY'], {
    supplierRef: 'AE-PI-26-0412',
  });
  ...
  await advance(poGulf.id, ['SENT', 'CONFIRMED', 'IN_PRODUCTION'], {
    supplierRef: 'HY20260611-07',
    confirmedReadyDate: daysAgo(12),
  });
  ...
  await pos.allocate(wei, {
    salesOrderLineId: deltaL2!,
    purchaseOrderLineId: huaxinLines[0]!.id,
    qty: '24',
    uom: 'MT',
    substituteNote: null,
  });
  ...
  await pos.allocate(wei, {
    salesOrderLineId: nileL1!,
    purchaseOrderLineId: huaxinLines[1]!.id,
    qty: '24',
    uom: 'MT',
    substituteNote: null,
  });
  ...
  await pos.saveMilestone(wei, poAlnoor.id, {
    milestone: 'INSPECTION',
    plannedDate: daysAgo(42),
    actualDate: daysAgo(41),
    notes: 'SGS pre-shipment inspection passed',
  });
